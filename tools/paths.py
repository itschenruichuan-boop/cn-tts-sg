...
RAW_MPK = os.path.join(RAW, "voice.mpk")
...
SPEAKER_MAP = os.path.join(CONFIG, f"{GAME}_voice_speaker_map.json")

MODELS = os.path.join(ROOT, "models")
MODEL_BGE_M3 = os.path.join(MODELS, "bge-m3")
MODEL_WHISPER = os.path.join(MODELS, "faster-whisper-large-v3-turbo")
MODEL_INDEX_TTS = os.path.join(ROOT, "index-tts")
MODEL_INDEX_TTS_CKPT = os.path.join(MODEL_INDEX_TTS, "checkpoints")
